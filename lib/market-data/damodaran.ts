...
export const DAMODARAN_2026_FALLBACK: Record<string, DamodaranSectorData> = {
  ...
  retail_unified:               { sector: 'Retail (General)', evEbitda: 9.8, evSales: 0.41, beta: 0.82, wacc: 0.091 },
  food_service:                 { sector: 'Restaurant/Dining', evEbitda: 8.2, evSales: 0.72, beta: 0.67, wacc: 0.082 },
  hospitality:                  { sector: 'Hotel/Gaming', evEbitda: 14.6, evSales: 2.1, beta: 0.88, wacc: 0.095 },
  retail:                       { sector: 'Retail (General)', evEbitda: 9.8, evSales: 0.41, beta: 0.82, wacc: 0.091 },
  food:                         { sector: 'Restaurant/Dining', evEbitda: 8.2, evSales: 0.72, beta: 0.67, wacc: 0.082 },
