...
const HE: Record<EquifyGoalId, GoalStandardCopy> = {
  negotiation: {
    ...
    standardOfValue:
      'סטנדרט השווי: Market Value, בהתאם למטרת ההערכה שנבחרה (מכירה / M&A). הדוח מדגיש מכפילי עסקאות שנסגרו בפועל והגורמים שרוכש אסטרטגי בוחן. אינדיקציה אלגוריתמית בלבד — אינה חוות דעת חתומה.',
  ...
  fundraise: {
    ...
    standardOfValue:
      'סטנדרט השווי: Investment Value לשיחת גיוס הון. הדוח מדגיש את תרחיש הצמיחה (Bull) ואת הרגישות להנחות הצמיחה. אינדיקציה אלגוריתמית בלבד — אינה חוות דעת חתומה.',
  ...
  partner: {
    ...
    standardOfValue:
      'סטנדרט השווי: Fair Value לשימוש בשותפות. הדוח מדגיש את הרכב השווי ואת הנחות הסיכון כבסיס לשיחה בין שותפים. אינדיקציה אלגוריתמית בלבד — אינה חוות דעת חתומה.',
  ...
  bank: {
    ...
    standardOfValue:
      'סטנדרט השווי: Collateral / Going-Concern Value למימון בנקאי. הדוח מדגיש יציבות תזרים והרכב נכסים. אינדיקציה אלגוריתמית בלבד — אינה חוות דעת חתומה.',
  ...
  internal: {
    ...
    standardOfValue:
      'סטנדרט השווי: Managerial Value לשימוש פנימי. הדוח משמש נקודת בסיס לתכנון ולמעקב, עם טווח תרחישים והנחות מתועדות. אינדיקציה אלגוריתמית בלבד — אינה חוות דעת חתומה.',
