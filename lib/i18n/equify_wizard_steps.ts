...
const HE: EquifyWizardStepStrings = {
  common: {
    ...
    phoneHint: 'ליצירת קשר ותמיכה; הדוח המלא נשלח לאימייל',
    subSector: 'תת-ענף',
    ...
    unsureHint: 'תארו בקצרה מה העסק עושה, ונציע 2–3 התאמות.',
  ...
  step2: {
    ...
    effectiveMultipleTip:
      'מכפיל שוק מכויל לפי הענף. ניתן לדרוס ידנית במצב מומחה, והמנוע יחשב מחדש את רגל המכפיל.',
...
const EN: EquifyWizardStepStrings = {
  common: {
    ...
    phoneHint: 'For contact and support; the full report is emailed',
    ...
    unsureHint: 'Describe the business in a sentence, and we will suggest 2–3 matches.',
  ...
  step2: {
    ...
    effectiveMultipleTip:
      'Sector-calibrated market multiple. Override manually in expert mode, and the engine recalculates the multiples leg.',
